...
namespace status_base_model_namespace {
...
class status_base_model : public prob_grad {
private:
    int N;
    int K;
    int D;
...
public:
    status_base_model(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        static const char* function__ = "status_base_model_namespace::status_base_model";
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        for (int n = 1; n <= N; ++n) {
            lp_accum__.add(ordered_logistic_log<propto__>(get_base1(y,n,"y",1), multiply(get_base1(x,n,"x",1),beta), c));
        }
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "status_base_model_namespace::write_array";
        (void) function__; // dummy call to supress warning
        ...
        for (int n = 1; n <= N; ++n) {
            ...
            stan::math::assign(get_base1_lhs(eta,n,"eta",1), multiply(get_base1(x,n,"x",1),beta));
        }
    ...
    void write_csv(RNG& base_rng__,
        ...
        stan::io::reader<double> in__(params_r__,params_i__);
        stan::io::csv_writer writer__(o__);
        static const char* function__ = "status_base_model_namespace::write_csv";
        (void) function__; // dummy call to supress warning
        // read-transform, write parameters
        vector_d beta = in__.vector_constrain(D);
        writer__.write(beta);
...
typedef status_base_model_namespace::status_base_model stan_model;
